...
work_dir = 'work_dirs/Chula/AGSA_distilled'
...
train_cfg = dict(by_epoch=True, max_epochs=100, val_interval=1) # 300
val_cfg = dict()
test_cfg = dict()
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1, max_keep_ckpts=5, save_best='single-label/f1-score',rule='greater',), # 验证间隔, 最多保存多少个权重文件 按照该指标保存最优模型
