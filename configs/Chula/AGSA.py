...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1, max_keep_ckpts=2, save_best='single-label/f1-score',rule='greater',), # 验证间隔, 最多保存多少个权重文件 按照该指标保存最优模型
